...
The canonical source contains 59 tables across 27 published pages. Documentation policy freezes each page count, preserves generated `table`, `thead`, `th`, `tbody`, and `td` structure, and rejects unplanned additions, removals, or wrapper changes.

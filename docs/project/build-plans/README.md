...
| --- | --- | --- |
| [042](plan-042.md) | Active | S093 data-addon lifecycle UI, issue #185 |
...
data-addon subsystem: S092 established the permanent foundation and S093 adds
the first-class lifecycle and status interface.
...
#190 gates native-log platform claims but does not block S093.

...
| --- | --- | --- |
| [043](plan-043.md) | Active | S099 repository trust-boundary audit, issue #181 |
...
S099 trust-boundary gate required before broader workflow authority changes.
...
#190 gates native-log platform claims but does not block S099.

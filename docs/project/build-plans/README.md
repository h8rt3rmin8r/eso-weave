...
| --- | --- | --- |
| [042](plan-042.md) | Active | S094 lossless subscribed-event envelope, issue #198 |
...
first-class lifecycle and status interface, and S094 establishes the lossless
raw-event authority.
...
#190 gates native-log platform claims but does not block S094.

...
5. S072 is in progress and implements the placeholder-first local icon cache
   tracked by issue #116, including bounded local PNG and DDS transformation,
   explicit manifests, immutable objects, and generic fallback art.
6. Later slices continue the catalog foundation through issues #117 and #118
...
Issue #132 is also eligible, but issue #116 remains next in the order established
by epic #111 and supplies a renderable placeholder path without redistributing
game graphics. Installed v0.15.1 verification in issue #110, catalog field

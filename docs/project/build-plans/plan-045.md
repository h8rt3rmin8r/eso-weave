...
2. Issue #176 adds the persisted opt-in combined service lifecycle, discovery,
   status, authentication, and shared runtime host.
...
4. Issue #178 mounts the MCP adapter over the same snapshot authority and proves
   transport parity.

...
| Stale HUD presentation separation | `AppModel::view_at`, `HudRetentionState` | S098 proves default and bounds, every runtime/focus/signal cause, visible age, recovery, exact expiry, zero retention, and simultaneous authoritative gate closure in application tests |

...
| Life Dead, Recovering, Unknown, or otherwise not positively Alive | Pass through | Suppress and hand off the toggle | Advance the death authorization boundary, drop queued work or cancel remaining steps, and release held output | Disable, retain request, require a post-recovery cast observation | Blocked, retain request, then require a complete new retry interval after coherent death recovery |

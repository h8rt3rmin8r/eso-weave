...
| [plan-017.md](plan-017.md) | Active | Concise release notes (slice 047): derive a bounded Highlights excerpt from the full changelog, append an immutable tag-specific changelog link, and enforce the contract before publishing v0.12.0 (#51). |
| [plan-018.md](plan-018.md) | Active | Life state and automation safety (slice 048): rename and collapse System and State, publish authoritative Alive, Dead, Reincarnating, and Unknown state, and fail closed across every synthesis path (#53, #54, #55, and #58). |
| [plan-019.md](plan-019.md) | Active | World transition truth (slice 049): publish Unknown, Transitioning, and Active through B22, make activation depend on a complete fresh payload baseline, and present the lifecycle truthfully (#56). |
| [plan-020.md](plan-020.md) | Active | Roll-dodge truth and weave safety (slice 050): publish a bounded Unknown, Inactive, or Active state through B23 and suppress generated weave work without swallowing or replaying physical input (#57 and #60). |
| [plan-021.md](plan-021.md) | Active | Travel safety (slice 051): publish a bounded Unknown, Inactive, or Pending state through B24 and suppress every synthesized-input path during unsafe world or travel state (#59). |
| [plan-022.md](plan-022.md) | Active | Sprint safety (slice 052): complete bounded keyboard-mode on-foot sprint publication through the reserved B9 axis and defer auto-potion until explicit sprint ends (#17 and #61). |
| [plan-023.md](plan-023.md) | Active | v0.13.0 release preparation (slice 053): derive concise user-facing Highlights from the complete S048 through S052 record, validate the immutable tagged changelog link, and preserve version rollover and publication as post-merge actions (#68). |
| [plan-024.md](plan-024.md) | Active | Dashboard layout cohesion (slice 054): pair expanded card geometry, force collapsed stacking, align System and State interactions, normalize field labels, and preserve complete Live HUD text (#72, #73, #74, and #75). |
| [plan-025.md](plan-025.md) | Active | Ultimate resource visibility (slice 055): publish exact charge and bar-specific costs through protocol v5, then add a purple fourth meter with quarter landmarks, active-cost threshold, and fixed green Ready state (#71). |
| [plan-026.md](plan-026.md) | Active | v0.14.0 release preparation (slice 056): derive two concise Highlights from the complete S054 and S055 record while leaving version rollover, publication, and live Ultimate verification to their post-merge stages (#85). |
| [plan-027.md](plan-027.md) | Active | mdBook documentation foundation (slice 057): pin the static-site toolchain, establish the branded `docs/src` shell, enforce documentation contracts, and deploy checked output from `main` with least privilege (#79). |

...
- [ ] T018 [US4] Add the R1 timing appendix to `docs/ESO-Weave-Specification.md` (global-cooldown context, per-weapon-class heavy-attack defaults with sources, and the in-game validation owed) and update section 16 to mark R1 closed

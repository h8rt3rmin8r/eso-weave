...
- [x] T028 [P] Update section 10.3 of `docs/ESO-Weave-Specification.md` to document B4: its position, encoding, marker, state codes, checksum, the clear-on-non-decode rule, and the block count moving to 5. [FR-018]

...
- [x] Windows MSI payload and UI evidence, including the upgrade elevation variance, is complete.
- [x] Linux deb installation, launch, contract support, and accepted UI variance are complete.
- [x] Linux AppImage and tarball portable-package inspection is complete.
...
- [x] Every #84 and #83 gate maps to explicit evidence or an operator-accepted variance.

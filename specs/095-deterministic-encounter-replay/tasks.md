...
- [x] T025 Move issue and PR project items to PR review and wait for hosted CI/reviews
- [x] T026 Resolve every first-round review and request at most one second `@Codex` review
- [x] T027 Resolve second-round findings, verify green CI and zero open threads, then request operator merge ritual
